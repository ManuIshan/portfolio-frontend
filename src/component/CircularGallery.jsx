...
export default function CircularGallery({
  ...
  useEffect(() => {
    if (!containerRef.current || !galleryItems.length) return;

    const app = new App(containerRef.current, { items: galleryItems, bend, textColor, borderRadius, font, scrollSpeed, scrollEase });
    return () => {
      app.destroy();
    };
